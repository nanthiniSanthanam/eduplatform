...
class Command(BaseCommand):
    ...
    def create_modules_and_lessons(self, course, instructor):
        ...
        # Lesson with intermediate access (for registered users)
        lesson2 = Lesson.objects.create(
            ...
            basic_content='<h1>Setting Up Python</h1><p>This content requires a free account. Please register to view the full installation guide.</p>',
        ...
        # Lesson with advanced access (for premium users)
        lesson3 = Lesson.objects.create(
            ...
            basic_content='<h1>Object-Oriented Programming</h1><p>This is premium content. Please upgrade your account to access this lesson.</p>',
            intermediate_content='<h1>Object-Oriented Programming</h1><p>This is premium content requiring a paid subscription. You can view basic information about OOP here, but detailed examples require an upgrade.</p>',
