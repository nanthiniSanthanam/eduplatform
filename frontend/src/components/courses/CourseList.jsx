...
const CourseList = ({ 
          ...
          setCourses([
            {
              ...
              subtitle: "Learn front-end and back-end development with modern frameworks.",
              duration: "60 hours",
              level: "Intermediate",
            ...
            },
            {
              ...
              slug: "data-science",
              subtitle: "Master data analysis, visualization, and ML algorithms.",
              duration: "48 hours",
              level: "Advanced",
              has_certificate: true,
              price: 99.99,
            ...
            },
            {
              ...
              subtitle: "Master the art and science of testing software effectively.",
              duration: "40 hours",
              level: "All Levels",
              has_certificate: true,
              price: 79.99,
  ...
  const renderCourseCard = (course, index) => {
    return (
      <div className="card-premium reveal w-full" style={{ animationDelay: `${(index + 1) * 100}ms` }} key={course.id || index}>
        <div className="relative">
          {course.thumbnail ? (
            ...
            <div className={`w-full h-52 bg-${course.bg_color || 'primary-500'} flex items-center justify-center text-white text-xl font-bold`}>
              {course.title}
            </div>
          )}
        ...
        <div className="p-6">
          <div className="flex items-center mb-3">
            <span className={`bg-${course.bg_light || 'blue-50'} text-${course.text_color || 'primary-600'} text-xs font-semibold px-3 py-1 rounded-lg`}>
          ...
          <h3 className="text-xl font-bold mb-3 font-display text-gray-900">{course.title}</h3>
          ...
          <div className="flex flex-wrap items-center text-sm text-gray-500 mb-5 gap-2 md:gap-4">
            <div className="flex items-center">
              <i className="fa-regular fa-clock mr-1.5"></i> {course.duration || 'Self-paced'}
            </div>
            <div className="flex items-center">
              <i className="fa-solid fa-signal mr-1.5"></i> {course.level || 'All Levels'}
            </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100">
            ...
            <Link to={`/courses/${course.slug}`} className="px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors shadow-sm">
              View Course
            </Link>
          </div>
        </div>
    ...
    <section className="py-12 md:py-20 bg-white w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-16 reveal">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 font-display text-gray-900">{title}</h2>
        ...
        {showViewAll && (
          <div className="text-center mt-10 md:mt-14 reveal">
            <Link to="/courses" className="btn-premium bg-white border-2 border-primary-500 text-primary-600 hover:bg-primary-50">
