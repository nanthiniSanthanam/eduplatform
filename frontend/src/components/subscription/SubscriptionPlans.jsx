...
const SubscriptionPlans = ({ currentPlan = 'free', onSelectPlan = () => {} }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div 
                ...
                className={`rounded-lg shadow-lg divide-y divide-gray-200 flex flex-col ${
                  plan.recommended ? 'border-2 border-primary-500 ring-2 ring-primary-500 ring-opacity-50' : 'border border-gray-200'
                }`}
              >
                {plan.recommended && (
        ...
        <div className="mt-10 text-center">
          <p className="text-base font-medium text-gray-500">
            Need help choosing? <a href="/contact" className="text-primary-600 hover:text-primary-500">Contact us</a> for guidance.
          </p>
        </div>
      </div>
    </div>
