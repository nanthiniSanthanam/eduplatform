        ...
        data: [
          {
            ...
            excerpt: "Explore the emerging technologies that are reshaping industries and creating new opportunities for professionals.",
          ...
          },
          {
            ...
            excerpt: "Discover scientifically-proven strategies to improve your learning efficiency and remember more of what you study.",
          ...
          },
          {
            ...
            excerpt: "Learn how Lisa transformed her career from a complete beginner to a senior developer in just 18 months.",
            slug: "lisas-journey",
            date: "April 10, 2025",
            readTime: "6 min read",
    ...
    <section className="py-12 md:py-20 bg-white w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {posts.map((post, index) => (
              <div className="card-premium reveal" style={{ animationDelay: `${(index + 1) * 100}ms` }} key={post.id}>
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3 font-display text-gray-900">{post.title}</h3>
                  <p className="text-gray-600 mb-4">{post.excerpt}</p>
                  <Link to={`/blog/${post.slug}`} className="text-primary-600 font-medium hover:text-primary-700 inline-flex items-center group">
        ...
        <div className="text-center mt-10 md:mt-14 reveal">
          <Link to="/blog" className="btn-premium bg-white border-2 border-purple-500 text-purple-600 hover:bg-purple-50">
