...
const Tooltip = ({
  ...
  const arrows = {
    ...
    bottom: 'top-0 left-1/2 -translate-x-1/2 -translate-y-full border-b-current border-x-transparent border-t-0',
    left: 'right-0 top-1/2 translate-x-full -translate-y-1/2 border-l-current border-y-transparent border-r-0',
    right: 'left-0 top-1/2 -translate-x-full -translate-y-1/2 border-r-current border-y-transparent border-l-0',
  };
