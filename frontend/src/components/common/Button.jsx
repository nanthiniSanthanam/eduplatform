...
const Button = ({ 
  ...
  const variantClasses = {
    ...
    outline: 'bg-white border-2 border-primary-500 text-primary-600 hover:bg-primary-50',
    'outline-secondary': 'bg-white border-2 border-secondary-500 text-secondary-600 hover:bg-secondary-50',
    'outline-tertiary': 'bg-white border-2 border-tertiary-500 text-tertiary-600 hover:bg-tertiary-50',
    ghost: 'bg-transparent hover:bg-gray-100 text-gray-700',
    'ghost-white': 'bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/20',
...
Button.propTypes = {
  ...
  variant: PropTypes.oneOf([
    'primary', 'secondary', 'tertiary', 'outline', 'outline-secondary', 
    'outline-tertiary', 'ghost', 'ghost-white', 'link', 'danger', 'success', 'premium'
  ]),
