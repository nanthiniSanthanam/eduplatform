...
const Spinner = ({ 
  ...
  return (
    <div className={`${sizeClass} ${colorClass} ${className}`} aria-label="Loading" role="status" {...props}>
      <svg 
...
Spinner.propTypes = {
  ...
  color: PropTypes.oneOf(['primary', 'secondary', 'white', 'gray', 'black', 'success', 'error', 'warning']),
