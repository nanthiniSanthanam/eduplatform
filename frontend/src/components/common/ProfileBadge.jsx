    ...
    <div className={`flex items-center ${className}`}>
      ...
      <div className="flex-shrink-0">
        {avatarUrl ? (
          ...
          <div className={`${avatarSizeClass} rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-medium`}>
            {initials}
          </div>
        )}
      </div>
      ...
      <div className="ml-3">
        ...
        {role && (
          <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${roleColor} mt-1`}>
