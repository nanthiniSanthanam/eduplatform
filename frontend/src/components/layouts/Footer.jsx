    ...
    <footer className="bg-gray-800 text-white py-12 w-full">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Empowering learners worldwide through accessible, high-quality education and innovative learning experiences.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Get the latest updates and educational content delivered to your inbox.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} SoftTech Solutions Educational Platform. All rights reserved.</p>
          <p className="mt-1">
            Designed and developed by Professor Santhanam
          </p>
        </div>
      </div>
    </footer>
