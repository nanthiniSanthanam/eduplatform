...
export const COMPONENT_STYLES = {
  // Button variants
  button: {
    primary: 'bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-lg transition-all duration-300',
    secondary: 'bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded-lg transition-all duration-300',
    tertiary: 'bg-tertiary-500 hover:bg-tertiary-600 text-white font-medium rounded-lg transition-all duration-300',
    outline: 'border border-primary-500 text-primary-500 hover:bg-primary-50 font-medium rounded-lg transition-all duration-300',
    ghost: 'text-primary-500 hover:bg-primary-50 font-medium rounded-lg transition-all duration-300',
    premium: 'px-4 py-2 sm:px-6 sm:py-3 font-medium rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-0.5',
    // Button sizes
    sizes: {
  ...
  card: {
    ...
    premium: 'bg-white rounded-xl shadow-card overflow-hidden transition-all duration-300 hover:shadow-soft hover:-translate-y-1',
    bordered: 'bg-white border border-gray-200 rounded-xl',
    glass: 'bg-white/10 backdrop-blur-md border border-white/10 rounded-xl',
  },
  // Input styles
  input: {
    default: 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200',
    error: 'w-full px-4 py-2 border border-red-500 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-colors duration-200',
  },
  // Container styles
  container: {
