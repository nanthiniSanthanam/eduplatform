...
const PricingPage = () => {
  const { currentUser, isAuthenticated, subscription, upgradeSubscription } = useAuth();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {SUBSCRIPTION_PLANS.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Action button */}
                  <Button
                    color={isCurrentPlan ? "secondary" : (plan.recommended ? "primary" : colors.button)}
                    fullWidth
                    className="mt-8"
          ...
          <div className="mt-10 text-center">
            <p className="text-base text-gray-600">
              ...
              <br />
              Need help choosing? <a href="/contact" className="text-primary-600 hover:underline">Contact us</a> for guidance.
            </p>
          </div>
        </div>
      </div>
