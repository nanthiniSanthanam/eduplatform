...
const NEXT_STEPS = [
  {
    ...
    description: 'Explore our library of advanced courses with your new subscription.',
    icon: (
  ...
  },
  {
    ...
    description: 'Complete your learning profile to get personalized recommendations.',
    icon: (
      <svg className="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-8">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {NEXT_STEPS.map((step, index) => (
                  <div key={index} className="bg-white shadow-md rounded-lg p-6 text-left">
                    <div className="mb-4">
                      {step.icon}
                    </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              >
                {from && !from.startsWith('/dashboard') ? 'Continue Where You Left Off' : 'Go to Dashboard'}
              </Button>
