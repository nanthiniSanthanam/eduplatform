      ...
      <MainLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-primary-700 font-medium">Loading plan information...</p>
          </div>
        </div>
      </MainLayout>
    );
            ...
            <Card className="md:col-span-1 p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${planInfo.price}/{planInfo.billingCycle}</span>
                </div>
                
                <div className="border-t border-gray-200 pt-4 flex justify-between">
                  <span className="font-medium">Total</span>
                  <span className="font-bold">${planInfo.price}/{planInfo.billingCycle}</span>
                </div>
              </div>
              
              <div className="mt-6 text-sm text-gray-500">
                <p>You will be charged ${planInfo.price} every {planInfo.billingCycle}.</p>
                <p className="mt-1">You can cancel your subscription at any time from your account settings.</p>
              </div>
            </Card>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    {PAYMENT_METHODS.map((method) => (
                      <div key={method.id} className="flex items-center">
                        ...
                        />
                        <label htmlFor={`payment-${method.id}`} className="ml-3 text-gray-700">
                          {method.name}
                        </label>
                      </div>
                    ))}
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  <Button
                    ...
                    disabled={loading}
                  >
                    {loading ? 'Processing...' : `Pay $${planInfo.price} and Subscribe`}
                  </Button>
                </div>
              </form>
