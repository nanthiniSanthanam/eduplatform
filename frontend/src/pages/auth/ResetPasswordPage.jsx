 ...
 * Purpose: Allows users to set a new password after reset request
 * 
 * Key features:
 * 1. Validates reset token from URL
 ...
 * - Connects with authService.resetPassword API
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setStatus('error');
        setMessage(result.error || 'Failed to reset password. The link may be invalid or expired.');
      }
    } catch (error) {
      setStatus('error');
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {status === 'success' ? (
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-red-800">{message}</p>
              <div className="mt-6">
                <Link 
                  to="/forgot-password" 
