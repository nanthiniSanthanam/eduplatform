...
import { courseService, testimonialService, statisticsService } from '../services/api';
            ...
            <div className="hidden md:block">
              <div className="relative">
                <div className="bg-white rounded-lg shadow-xl p-6 w-full h-80">
                  <h3 className="text-center text-xl text-gray-700 mb-4">Interactive Learning Platform</h3>
      ...
      <div className="bg-gray-100 py-12 w-full">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              <div className="text-4xl font-bold text-primary-600 mb-2">{stats.totalStudents}+</div>
              <div className="text-gray-600 text-lg">Active Learners</div>
            </div>
            <div className="bg-white p-8 rounded-lg shadow">
              <div className="text-4xl font-bold text-primary-600 mb-2">{stats.totalInstructors}+</div>
