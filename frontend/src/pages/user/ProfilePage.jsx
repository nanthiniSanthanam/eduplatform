    ...
    const fetchUserProfile = async () => {
      try {
        ...
        const mockUser = {
          ...
          profileImage: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=3&w=256&h=256&q=80',
          joined: '2025-01-15',
            ...
            <div className="w-full max-w-3xl">
              <div className="bg-white shadow overflow-hidden rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <h2 className="ml-3 text-lg font-medium text-gray-900">Error</h2>
                </div>
            ...
            <div className="bg-white shadow overflow-hidden rounded-lg sticky top-6">
              ...
              <div className="p-6">
                ...
                <div className="mt-6 border-t border-gray-200 pt-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-primary-600">{user.coursesEnrolled}</p>
                      <p className="text-sm text-gray-500">Courses Enrolled</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-primary-600">{user.coursesCompleted}</p>
                      <p className="text-sm text-gray-500">Courses Completed</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-primary-600">{user.certificatesEarned}</p>
                      <p className="text-sm text-gray-500">Certificates</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-primary-600">{user.totalHours}</p>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
                ...
                <div className="mt-2 flex space-x-3">
                  {user.twitter && (
                    <a href={`https://twitter.com/${user.twitter}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500">
                  ...
                  {user.linkedin && (
                    <a href={`https://linkedin.com/in/${user.linkedin}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500">
                  ...
                  {user.website && (
                    <a href={user.website} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-500">
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="border-b border-gray-200">
                <nav className="-mb-px flex" aria-label="Tabs">
                  {['account', 'security', 'notifications', 'integrations'].map((tab) => (
                    <button
                      key={tab}
              ...
              <div className="p-6">
                  ...
                  <div>
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <h4 className="sm:col-span-6 text-base font-medium text-gray-900">Social Profiles</h4>
                  ...
                  <div>
                    ...
                    <div className="bg-white shadow sm:rounded-lg mb-8">
                      <div className="px-4 py-5 sm:p-6">
                        <h3 className="text-base font-medium leading-6 text-gray-900">Change Password</h3>
                    ...
                    <div className="bg-white shadow sm:rounded-lg mb-8">
                      <div className="px-4 py-5 sm:p-6">
                        <h3 className="text-base font-medium leading-6 text-gray-900">Two-factor Authentication</h3>
                    ...
                    <div className="bg-white shadow sm:rounded-lg mb-8">
                      <div className="px-4 py-5 sm:p-6">
                        <h3 className="text-base font-medium leading-6 text-gray-900">Active Sessions</h3>
                        <div className="mt-2 max-w-xl text-sm text-gray-500">
                          <p>These are devices that have logged into your account. Remove those that you don't recognize.</p>
                        </div>
                        <div className="mt-4 divide-y divide-gray-200">
                          <div className="py-4 flex justify-between">
                            <div>
                              <p className="text-sm font-medium text-gray-900">Current Session (Windows - Chrome)</p>
                              <p className="text-xs text-gray-500">Chennai, India - {lastLogin}</p>
                            </div>
                          ...
                          <div className="py-4 flex justify-between">
                            <div>
                              <p className="text-sm font-medium text-gray-900">iOS - Safari</p>
                              <p className="text-xs text-gray-500">Chennai, India - 2 days ago</p>
                            </div>
                            <button
                              type="button"
                    ...
                    <div className="bg-white shadow sm:rounded-lg border border-red-200">
                      <div className="px-4 py-5 sm:p-6">
                        <h3 className="text-base font-medium leading-6 text-gray-900">Delete Account</h3>
                        <div className="mt-2 max-w-xl text-sm text-gray-500">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="mt-4 space-y-4">
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                              ...
                              <p className="text-gray-500">Get notified when an instructor posts an update to a course you're taking.</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                              ...
                              <p className="text-gray-500">Receive an email when someone sends you a direct message.</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                              <label htmlFor="reminders" className="font-medium text-gray-700">Learning reminders</label>
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                              ...
                              <p className="text-gray-500">Receive emails about new courses, promotions, and other marketing communications.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Configure push notifications to stay updated on mobile and desktop.
                        </p>
                        <div className="mt-4">
                          <button
                            type="button"
                ...
                {activeTab === 'integrations' && (
                  <div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-between py-4 border-b border-gray-200">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Connect your Google account for seamless sign-in and calendar integration.</p>
                          </div>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="flex items-center justify-between py-4 border-b border-gray-200">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Connect your Facebook account to share achievements and find friends.</p>
                          </div>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="flex items-center justify-between py-4 border-b border-gray-200">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <h4 className="text-base font-medium text-gray-900">GitHub</h4>
                            <p className="text-sm text-gray-500">Connect your GitHub account to showcase your coding projects.</p>
                          </div>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="flex items-center justify-between py-4 border-b border-gray-200">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <h4 className="text-base font-medium text-gray-900">Slack</h4>
                            <p className="text-sm text-gray-500">Connect your Slack account for learning community notifications.</p>
                          </div>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="flex items-center justify-between py-4">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Connect your LinkedIn account to add certificates to your profile.</p>
                          </div>
                        </div>
                        <button
                          type="button"
                    ...
                    <div className="mt-10">
                      <h3 className="text-lg font-medium text-gray-900 mb-6">API Access</h3>
                      
                      <div className="bg-white shadow sm:rounded-lg border border-gray-200">
                        <div className="px-4 py-5 sm:p-6">
                          <h3 className="text-base font-medium leading-6 text-gray-900">Developer API</h3>
                          <div className="mt-2 max-w-xl text-sm text-gray-500">
                            <p>Generate API keys to access your data programmatically.</p>
                          </div>
                          <div className="mt-5">
                            <button
                              type="button"
