...
const ERROR_MESSAGES = {
  notFound: "We couldn't find this certificate. It may have been removed or you don't have access to it.",
  loadFailed: "Failed to load the certificate. Please try again later.",
  subscriptionRequired: "Certificates are only available to premium subscribers. Please upgrade your subscription to access this feature."
};
...
const CertificatePage = () => {
  ...
  useEffect(() => {
    const loadCertificate = async () => {
      ...
      if (!isAuthenticated()) {
        navigate('/login', { state: { from: `/certificates/${certificateId}` } });
        return;
      }
      ...
      <MainLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-primary-700 font-medium">Loading certificate...</p>
          </div>
        </div>
      </MainLayout>
    );
